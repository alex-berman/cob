...
class OscSender:
    ...
    def send(self, address_pattern, *args):
        with self._lock:
            self._send_non_threadsafe(address_pattern, *args)

    def _send_non_threadsafe(self, address_pattern, *args):
    ...
    def _send(self, string):
        self._socket.sendto(string, (self._host, self._port))
